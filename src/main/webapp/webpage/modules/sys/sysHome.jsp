   ...
   <div class="row  border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <blockquote class="text-info" style="font-size:14px">Intelligent Vehicle Management System（IVMS）是一款基于车辆管理的智能化管理平台，引领新的管理模式模式(车辆管理\行程安排\收支统计)， 可以帮助解决车队派单，管理的问题。同时还具备自动收支结算功能，方便账单的统计和生成。
    			<br/>
               <br>IVMS采用了目前极为流行的扁平化响应式的设计风格，可以完美的兼容电脑，pad，手机等多个平台。前端UI采用了<a target="_blank" href="https://wrapbootstrap.com/theme/inspinia-responsive-admin-theme-WB0R5L90S">INSPINIA</a>(点击访问）为原型开发，sudao v2.0发布时作者将bootstrap升级到了最新的3.3.4。
                <br>…………
            </blockquote>
