...
<html>
	...
	<head>
		...
		<!-- sudao -->
		<link href="${ctxStatic}/common/sudao.css" type="text/css" rel="stylesheet" />
		<script src="${ctxStatic}/common/sudao.js" type="text/javascript"></script>
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/register/registerUser" method="post" class="form-group form-horizontal">
												<input  type="hidden" value="common" name="roleName"><!-- 默认注册用户都是超级管理员 -->
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
													...
													<label class="block">
														...
														<span class="lbl">
															我接受
															<a href="#">《Intelligent Vehicle Management System用户注册协议》</a>
														</span>
							...
							<div class="center"><h4 class="blue" id="id-company-text">&copy; Intelligent Vehicle Management System</h4></div>
